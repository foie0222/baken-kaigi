...
### クイックリプライのカテゴリ（状況に応じて選択）

**レース分析系**: 「荒れそう？」「堅い？」「展開予想は？」
**馬分析系**: 「穴馬は？」「本命は？」「危険な人気馬は？」
**買い目調整系**: 「相手を絞って」「保険を追加」「金額調整」
**リスク管理系**: 「トリガミ確認」「リスク分散」「撤退ライン」

### 状況に応じた提案例

- 荒れそうなレース → 「穴馬を探して」「堅い組み合わせは？」「保険の買い目は？」
- 本命が強いレース → 「相手を絞って」「2着候補は？」「トリガミにならない？」
- 金額が大きい場合 → 「リスク分散したい」「的中率重視で」「もう少し抑えたい」
- 初回の分析後 → 「展開予想は？」「騎手の成績は？」「過去の傾向は？」
